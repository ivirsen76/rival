...
type Params = { config: Config; cancelCode: string; creditAmount: number; levelName: string; seasonName: string };

export default ({ config, cancelCode, creditAmount, levelName, seasonName }: Params) => {
    const cancelText =
