...
type Params = { config: Config; referralName: string };

export default ({ config, referralName }: Params) => {
  ...
  <mj-text>Your friend, <b>${referralName}</b>, just made their first payment in the ${
      config.city
